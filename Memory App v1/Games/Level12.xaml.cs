...
namespace Memory_App_v1.Games
{
    ...
    /// </summary>
    public sealed partial class Level12 : Page
    {

        static string[] unitsShowns = new string[14];
       ...
       static List<Image> list_images = new List<Image>();
        ...
        public Level12()
        {
            ...
            unitsShowns[0] = random.Next(0, 10).ToString();

            for (int i = 0; i < 14; i++)  //making numbers
            {
            ...
            tbkUnitsShowing1.Text = unitsShowns[0].ToString() + unitsShowns[1].ToString();
            tbkUnitsShowing2.Text = unitsShowns[2].ToString() + unitsShowns[3].ToString();
            tbkUnitsShowing3.Text = unitsShowns[4].ToString() + unitsShowns[5].ToString();
            tbkUnitsShowing4.Text = unitsShowns[6].ToString() + unitsShowns[7].ToString();
            tbkUnitsShowing5.Text = unitsShowns[8].ToString() + unitsShowns[9].ToString();
            tbkUnitsShowing6.Text = unitsShowns[10].ToString() + unitsShowns[11].ToString();
            tbkUnitsShowing7.Text = unitsShowns[12].ToString() + unitsShowns[13].ToString();
        ...
        private void dispatcherTimer_Tick(object sender, object e)
        {
            if (dateTime.Second == 0)
            {
                ...
                list_storyboards[j * 2].Completed -= Level12_Completed;

                dateTime2 = dateTime2.AddSeconds(0.5);
        ...
        private void CreateAndAnimateCards(int i)      //i indicates the index of list_images and list_storyboards 
        {
            ...
            list_storyboards[i * 2].Completed += Level12_Completed;
        }

        private void Level12_Completed(object sender, object e)
        {
            dispatcherTimer.Tick += dispatcherTimer_Tick;
        ...
        {
            Frame.Navigate(typeof(Games.Level12Answer));
        }
