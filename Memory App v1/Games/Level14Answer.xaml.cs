...
namespace Memory_App_v1.Games
{
    ...
    /// </summary>
    public sealed partial class Level14Answer : Page
    {

        bool advanceToC5 = true;
        ...
        public Level14Answer()
        {
            this.InitializeComponent();

            tbkNumberOfCardsRemaining.Text = "Number of cards remaining: " + Level14.List_images.Count;
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk1, image_S1, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk2, image_S2, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk3, image_S3, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk4, image_S4, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk5, image_S5, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk6, image_S6, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk7, image_S7, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk8, image_S8, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk9, image_S9, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk10, image_S10, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk11, image_S11, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk12, image_S12, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbk13, image_S13, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH1, image_H1, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH2, image_H2, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH3, image_H3, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH4, image_H4, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH5, image_H5, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH6, image_H6, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH7, image_H7, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH8, image_H8, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH9, image_H9, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH10, image_H10, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH11, image_H11, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH12, image_H12, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkH13, image_H13, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC1, image_C1, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC2, image_C2, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC3, image_C3, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC4, image_C4, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC5, image_C5, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC6, image_C6, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC7, image_C7, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC8, image_C8, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC9, image_C9, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC10, image_C10, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC11, image_C11, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC12, image_C12, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkC13, image_C13, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD1, image_D1, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD2, image_D2, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD3, image_D3, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD4, image_D4, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD5, image_D5, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD6, image_D6, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD7, image_D7, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD8, image_D8, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD9, image_D9, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD10, image_D10, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD11, image_D11, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD12, image_D12, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        {
            ImagePressed14 i = new ImagePressed14(tbkD13, image_D13, list_images, list_textBlocks, pressedNumber, tbkNumberOfCardsRemaining);
        ...
        private void btnCheck_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (tbxNumber1_Answer.Text[i].ToString() == Level14.UnitsShowns[i + 0])
                {
            ...
            {
                if (list_orderOfCardsPressed[i] == Level14.List_OrderOfCardsShown[i])
                {
                    tbkResult.Text += "\nCard " + (i+1).ToString() + ": Correct ";
                }
                else
                {
                    tbkResult.Text += "\nCard " + (i + 1).ToString() + ": Incorrect || Correct Answer: " + Level14.List_OrderOfCardsShown[i];
                    advanceToC5 = false;
                }
            }

            //if the user pressed a fewer number of cards than was shown, the check_tbkCheck writes "Missed"
            for (int i = list_orderOfCardsPressed.Count; i < Level14.List_OrderOfCardsShown.Count; i++)
            {
                tbkResult.Text += "\nCard " + (i + 1).ToString() + ": Missed || Correct Answer: " + Level14.List_OrderOfCardsShown[i];
                advanceToC5 = false;
            }
            ...
            if (numberAllRight == 0)
            {
                tbkResult.Text += "\nNumbers: Incorrect || Correct Answer: " + Level14.UnitsShowns[0] + Level14.UnitsShowns[1] + Level14.UnitsShowns[2]
                    + Level14.UnitsShowns[3] + Level14.UnitsShowns[4] + Level14.UnitsShowns[5] + Level14.UnitsShowns[6] + Level14.UnitsShowns[7] + Level14.UnitsShowns[8]
                    + Level14.UnitsShowns[9] + Level14.UnitsShowns[10] + Level14.UnitsShowns[11] + Level14.UnitsShowns[12] + Level14.UnitsShowns[13] + Level14.UnitsShowns[14]
                    + Level14.UnitsShowns[15] + Level14.UnitsShowns[16] + Level14.UnitsShowns[17] + Level14.UnitsShowns[18] + Level14.UnitsShowns[19] + Level14.UnitsShowns[20]
                    + Level14.UnitsShowns[21] + Level14.UnitsShowns[22] + Level14.UnitsShowns[23] + Level14.UnitsShowns[24] + Level14.UnitsShowns[25] + Level14.UnitsShowns[26]
                    + Level14.UnitsShowns[27] + Level14.UnitsShowns[28] + Level14.UnitsShowns[29] + Level14.UnitsShowns[30] + Level14.UnitsShowns[31] + Level14.UnitsShowns[32]
                    + Level14.UnitsShowns[33] + Level14.UnitsShowns[34] + Level14.UnitsShowns[35] + Level14.UnitsShowns[36] + Level14.UnitsShowns[37] + Level14.UnitsShowns[38]
                    + Level14.UnitsShowns[39];
                tbxNumber1_Answer.Foreground = new SolidColorBrush(Colors.Red);
            }
            if (numberAllRight == 2)
            {
                tbkResult.Text += "\nNumbers: Missed || Correct Answer: " + Level14.UnitsShowns[0] + Level14.UnitsShowns[1] + Level14.UnitsShowns[2]
                    + Level14.UnitsShowns[3] + Level14.UnitsShowns[4] + Level14.UnitsShowns[5] + Level14.UnitsShowns[6] + Level14.UnitsShowns[7] + Level14.UnitsShowns[8]
                    + Level14.UnitsShowns[9] + Level14.UnitsShowns[10] + Level14.UnitsShowns[11] + Level14.UnitsShowns[12] + Level14.UnitsShowns[13] + Level14.UnitsShowns[14]
                    + Level14.UnitsShowns[15] + Level14.UnitsShowns[16] + Level14.UnitsShowns[17] + Level14.UnitsShowns[18] + Level14.UnitsShowns[19] + Level14.UnitsShowns[20]
                    + Level14.UnitsShowns[21] + Level14.UnitsShowns[22] + Level14.UnitsShowns[23] + Level14.UnitsShowns[24] + Level14.UnitsShowns[25] + Level14.UnitsShowns[26]
 ...
 class ImagePressed14
    {
        ...
        public ImagePressed14(TextBlock t, Image i, List<Image> list_i, List<TextBlock> list_t, int pressed, TextBlock cRemaining)
        {
            textBlock = t;
            image = i;
            list_images2 = list_i;
        ...
        public void MainOperation()
        {
            if (image.Opacity == 1)
            {
                if (Level14.List_images.Count - pNumber == 0)          //if there are no more cards remaining, we do not add additional 
                ...
                {
                    pNumber++;
                    Level14Answer.PressedNumber = pNumber;

                    image.Opacity = 0.4;
                    textBlock.Opacity = 1;
                    textBlock.Text = Level14Answer.PressedNumber.ToString();
            ...
            cardsRemaining.Text = "Number of cards remaining: " + (Level14.List_images.Count - pNumber).ToString();
        }
